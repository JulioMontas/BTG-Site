...
const GlobalContact = (props) => (
  <div className={globalContactStyles.subSection} style={{background: theme.colorsBG.primary, color: theme.colorsText.secondary, }}>
    <div className="container">
      <div className={globalContactStyles.twoColumnsGrid}>
        <div>
          <h2 className={globalContactStyles.contactTitle}>
      ...
      <div className={globalContactStyles.customWaveBottom}>
