  ...
  return (
    ...
    >
      <div className={practiceAreasBtnStyles.wrapper}>
        <StaticImage
          src="https://images.unsplash.com/photo-1593115057322-e94b77572f20?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80"
          alt="A dinosaur"
